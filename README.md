...
### 2. [GitHub](https://github.com/NIFCloud-mbaas/AndroidSegmentUserApp)からサンプルプロジェクトのダウンロード

* 下記リンクをクリックしてプロジェクトをローカルにダウンロードします

 * __[AndroidSegmentUserApp](https://github.com/NIFCloud-mbaas/AndroidSegmentUserApp/archive/master.zip)__
